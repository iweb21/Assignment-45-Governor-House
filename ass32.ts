...
let current_users = ["ahad","samad","bilal","Ali","imran","zeeshan","Affan"];

let new_users = ["Ahmed","ali","danish","Ahad","haziq"];
...
if(userNameTaken){
    ...
    (console.log(`${new_users} need to choose a new username because its already taken `))
} else {
